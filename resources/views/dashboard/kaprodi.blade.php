                        ...
                        <div class="card shadow-smooth custom-card h-100 custom-card bg-white">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <span class="fe fe-24 bi-person-lines-fill text-dark font-weight-bold mb-0"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card shadow-smooth custom-card h-100 custom-card bg-white">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h6 class="h7 text-dark font-weight-bold">Mahasiswa Skripsi</h6>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card shadow-smooth custom-card h-100 custom-card bg-white">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h6 class="h7 text-dark font-weight-bold">Mahasiswa Lulus Skripsi</h6>
                                        <h4 class="text-dark font-weight-bold">{{ 0 }}</h4>
                                    </div>
                                    <div class="col-auto">
                                        <span class="fe fe-24 bi-tools text-dark font-weight-bold mb-0"></span>
