                        ...
                        <div class="card shadow-smooth custom-card h-100 custom-card bg-white">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h6 class="h6 text-dark font-weight-bold">Total Dosen</h6>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card shadow-smooth custom-card h-100 custom-card bg-white">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h6 class="h6 text-dark font-weight-bold">Total Industri</h6>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card shadow-smooth custom-card h-100 custom-card bg-white">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h6 class="h6 text-dark font-weight-bold">Topik dari Dosen</h6>
                                        <h4 class="text-dark font-weight-bold">{{ 0 }}</h4>
                                    </div>
                                    <div class="col-auto">
                                        <span class="fe fe-24 bi-tools text-dark font-weight-bold mb-0"></span>
                                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card shadow-smooth custom-card h-100 custom-card bg-white">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h6 class="h6 text-dark font-weight-bold">Topik dari Industri</h6>
                                        <h4 class="text-dark font-weight-bold">{{ 0 }}</h4>
                                    </div>
                                    <div class="col-auto">
                                        <span class="fe fe-24 bi-tools text-dark font-weight-bold mb-0"></span>
                ...
                <div class="card shadow-smooth custom-card mb-2">
                    <div class="card-body" data-simplebar style="max-height:80%; overflow-y: auto; overflow-x: hidden;">
                        ...
                        @else
                            ...
                            @endforeach
                        @endif
                        <h6 class="m6-3 mt-3 h6">Besok</h6>
                        ...
                        @else
                            ...
                            @endforeach
                        @endif
                        <h6 class="m6-3 mt-3 h6">Minggu Ini</h6>
