...
@section('content')
                                    ...
                                    <div class="col ml-auto">
                                        <div class="dropdown float-right">
                                            <button class="btn btn-primary float-right ml-3" type="button"
                                                data-toggle="modal" data-target="#createModalPersyaratan"
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a class="dropdown-item" href="#" type="button"
                                                                    data-toggle="modal"
                                                                    data-target="#editModalPersyaratan{{ $item->id }}"
    ...
    @include('pages.berkas.persyaratan.edit')
    <script>
        function deleteActivity(itemId) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route('persyaratan.destroy', 'id') }}'.replace("id", itemId),
                        type: 'DELETE',
                        headers: {
