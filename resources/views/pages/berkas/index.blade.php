                                                        ...
                                                        <td class="text-center">
                                                            <div class="custom-control custom-checkbox">
                                                                ...
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    id="customCheck{{ $item->id }}" value="1"
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover mb-5">
                                        <thead>
                                            <tr>
                                                <th class="text-center font-weight-bold text-dark">No</th>
                                                <th colspan="2" class="text-center font-weight-bold text-dark">
                                                    Aspek
                                                    yang
                                                    di nilai</th>
                                                <th colspan="2" class="text-center font-weight-bold text-dark">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover mb-5">
                                        <thead>
                                            <tr>
                                                <th rowspan="2" class="text-center font-weight-bold text-dark">
                                                    No
                                                </th>
                                                <th rowspan="2" class="text-center font-weight-bold text-dark">
                                                    MATERI
                                ...
                                <form action="{{ route('asistensi.update') }}" method="POST">
                                    ...
                                    <div class="toolbar row mb-3">
                                        <div class="col ml-auto">
                                            <div class="dropdown float-right">
                                                ...
                                                <button class="btn btn-primary float-right ml-3" type="button"
                                                    data-toggle="modal" data-target="#createModalAsistensi"
                                                    data-whatever="@mdo">Tambah +</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover mb-0">
                                            <thead>
                                                <tr role="row">
                                                    <th colspan="4" class="text-center font-weight-bold text-dark">
                                                        KEGIATAN
