    ...
    <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('laporan-usulan-proposal.update', $item->id) }}" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="judul_proposal" name="judul_proposal"
                                value="{{ $item->judul_proposal }}" required>
                        </div>
                        <div class="form-group">
                            <label for="bidang_kajian" class="required">Bidang Kajian</label>
                            <textarea name="bidang_kajian" id="bidang_kajian" cols="30" rows="6" class="form-control" required>{{ $item->bidang_kajian }}</textarea>
                        </div>
                        <div class="form-group">
