...
@section('content')
                ...
                <div class="row">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Data Dosen Penguji</li>
                        </ol>
                    </nav>
                    <div class="col-md-12">
                        <div class="card shadow-smooth custom-card">
                            <div class="card-body">
                                @can('akses tambah-dospeng')
                                    ...
                                    <table class="table dataTables" id="dataTable-1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Email Dosen</th>
                                                <th>No Telepon</th>
                                                <th>Penguji Jenjang Pendidikan</th>
                                                <th>Status</th>
                                                <th>Foto</th>
    ...
    @include('pages.datamaster.data-dospeng.create')
    @include('pages.datamaster.data-dospeng.edit')
@endsection
