...
@section('content')
                ...
                <div class="row">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Data Keilmuan</li>
                        </ol>
                    </nav>
                    <div class="col-md-12">
                        <div class="card shadow-smooth custom-card">
                            <div class="card-body">
                                @can('akses tambah-keilmuan')
    ...
    @include('pages.datamaster.data-keilmuan.create')
    @include('pages.datamaster.data-keilmuan.edit')
@endsection
