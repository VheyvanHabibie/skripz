            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Detail Data Mitra Industri</li>
                    </ol>
                </nav>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="jabatan_pj" name="jabatan_pj"
                                            value="{{ $mitra->jabatan_pj }}" readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="email_pj" name="email_pj"
                                            value="{{ $mitra->email_pj }}" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="no_telepon_pj" class="required">No Telepon Penanggung Jawab</label>
                                        <input type="text" class="form-control" id="no_telepon_pj" name="no_telepon_pj"
                                            value="{{ $mitra->no_telepon_pj }}" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="deskripsi" class="required">Deskripsi</label>
                                        <textarea class="form-control" id="deskripsi" name="deskripsi" readonly>{{ $mitra->deskripsi }}</textarea>
                                    </div>
