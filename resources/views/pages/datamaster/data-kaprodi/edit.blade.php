                ...
                <form action="{{ route('kaprodi.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nip_kaprodi" name="nip_kaprodi" value="{{ old('nip_kaprodi', $item->nip_kaprodi) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="no_telepon" name="no_telepon" value="{{ old('no_telepon', $item->no_telepon) }}"
                        ...
                        <div class="form-group">
                            ...
                            <select id="simple-select2" name="pts_id"
                                ...
                                @foreach ($pts as $pt)
                                    <option value="{{ $pt->id }}" {{ old('pts_id', $item->user->pts_id) == $pt->id ? 'selected' : '' }}>
