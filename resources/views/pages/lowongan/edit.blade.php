                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control" name="nama_perusahaan" value="{{ $lowongan->nama_perusahaan }}" required>
                            </div>
                            <div class="form-group mb-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea name="deskripsi_pekerjaan" id="" cols="30" rows="8" class="form-control" required>{{ old('deskripsi_pekerjaan', $lowongan->deskripsi_pekerjaan) }}</textarea>
                            </div>
                        ...
                        <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <select id="provinsi_{{ $lowongan->id }}" name="provinsi_id" class="form-control" data-id="{{ $lowongan->id }}">
                                        <option value="">-- Pilih Provinsi --</option>
                                        @foreach ($provinsis as $provinsi)
                                            <option value="{{ $provinsi->id }}" {{ $lowongan->provinsi_id == $provinsi->id ? 'selected' : '' }}>
                                                {{ $provinsi->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="kabupaten_{{ $lowongan->id }}" name="kabupaten_id" class="form-control" data-selected-id="{{ $lowongan->kabupaten_id }}">
                                        <option value="">-- Pilih Kabupaten / Kota --</option>
                                    </select>
                                </div>
                            <div class="form-group mb-4">
                                <label for="lokasi_pekerjaan">Detail Lokasi</label>
                                <textarea name="lokasi_pekerjaan" id="" cols="30" rows="4" class="form-control" required>{{ old('lokasi_pekerjaan', $lowongan->lokasi_pekerjaan) }}</textarea>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="time" class="form-control" name="waktu_mulai"
                                            value="{{ old('waktu_mulai', $lowongan->waktu_mulai) }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="time" class="form-control" name="waktu_selesai"
                                            value="{{ old('waktu_selesai', $lowongan->waktu_selesai) }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="date" class="form-control" name="tanggal_berakhir"
                                    value="{{ old('tanggal_berakhir', $lowongan->tanggal_berakhir) }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    $(document).ready(function () {
        ...
        $('[id^="provinsi_"]').each(function () {
            ...
            if (provinsiDropdown.val()) {
                loadKabupaten(provinsiDropdown.val(), kabupatenDropdown, kabupatenDropdown.data('selected-id'));
            }
